...
<!-- Avatar upload — tiny inline helper that posts the picked file to
     /admin/upload (the same endpoint EasyMDE uses) and fills the avatar
     text field with the returned URL. -->
<script>
(function () {
